...
async function q() {
    return new Promise((e,o)=>{
        document.readyState === "complete" ? e() : document.addEventListener("readystatechange", t=>{
...
async function _e(e, o={}) {
    if (!pe) {
        ...
        try {
            ...
            if (n.message === "core version mismatch")
                throw n;
            console.log(n),
            ...
            try {
                ...
                try {
                    ...
                    throw console.log(r),
                    new Error("Cannot connect to core")
                }
            }
        }
        pe = !0
    ...
    if (t === null)
        throw new Error("null message response from core");
    if (t?.P)
        throw new Error(t.P);
    return t.result
}
...
function j(e, o, t, i) {
    ...
    n.className = "clickable";
    let a = document.createElement("span");
    if (i) {
        let r = document.createElement("span");
        r.textContent = l("newExclamation") + " ",
        a.appendChild(r)
    }
    return typeof e == "string" ? a.appendChild(document.createTextNode(e)) : a.appendChild(e),
    ...
    mi({li: o, ui: t, di: i, pi: n, hi: a, fi: r, gi: c, bi: u, wi: f, yi: p}) {
        o.onmousedown = y=>{
            ...
            Mo({
                ...
                ,
                W: ({F: b, k: d, dx: g, dy: w, A: Z, G: Ne, pageX: V, pageY: We})=>{
                    if (!this.so && !s && (Math.abs(g) > this.Ko || Math.abs(w) > this.Ko)) {
                        this.so = !0,
                        this.Ho = t,
                        this.Mo = p.offsetWidth,
                        this.zo = p.offsetHeight;
                        let R = Le(i);
                        this.xi = R.x,
                        this.vi = R.y,
                        this.ki = i.offsetWidth,
                        this._o = i.parentNode,
                ...
                _: ({F: b, k: d, O: g, V: w, A: Z, G: Ne})=>{
                    (async()=>{
                        if (!this.so)
                            ...
                            this.so = !1;
                            let V = this.po;
                            this.po ? await this.po.vo(this.Ho) : c(),
                            document.body.removeChild(this.xo),
                            V && (V.io.style.display = "none",
                            this.po = void 0),
                            u()
                        }
                    }
...
function io(e) {
    return e.metaKey || e.ctrlKey || e.altKey || e.shiftKey ? !1 : "buttons"in e ? e.buttons === 1 : "which"in e ? e.which === 1 : e.button === 1 || e.type === "click"
}
class no {
    ...
    Bo() {
        ...
        return o.setAttribute("autocomplete", "off"),
        ...
        o.value = this.value,
        this.Xo = this.value,
        o.onblur = ()=>(this.div.removeChild(o),
        ...
        o.onkeydown = t=>{
            t.isComposing || ((t.key === "Escape" || t.key === "Esc") && (o.value = this.Xo,
            this.value = this.Xo,
            o.blur()),
            t.key === "Enter" && o.blur()),
            this.Ti = !1
        ...
        o.oninput = t=>{
            ...
            return o.style.width = i + 30 + "px",
            this.div.style.width = i + 30 + "px",
            this.ko(o.value, !1),
            !1
        }
        ,
    ...
    Ai() {
        this.oo.style.width = "auto",
        this.div.style.width = "auto"
    }
    Ii() {
        let o = be(this.value, this.lo, this.mo, this.fontWeight, !1);
        return o = Math.max(o, 20),
        this.oo.style.width = o + "px",
        this.div.style.width = o + "px",
        o
    }
    Go(o, t, i) {
        this.value = U(o),
...
function be(e, o, t, i, n) {
    ...
    i === !0 && (i = "bold"),
    i === !1 && (i = "normal"),
    I === void 0 && (I = m(document.body, "div", {
        style: {
            visibility: "hidden",
            position: "absolute",
            [x()]: "-8000px",
...
function dt(e) {
    return e.indexOf("://") === -1 ? "https://" : (e = e.substring(0, e.indexOf("://") + "://".length),
    e.toLowerCase())
}
...
function ao(e) {
    ...
    try {
        for (let t in ke) {
            let i = "." + ke[t];
            if (fo(o, i)) {
                for (o = o.substring(0, o.length - i.length); o.indexOf(".") !== -1; )
                    o = o.substring(o.indexOf(".") + 1);
                o = o + i;
                break
            }
        }
        return o.indexOf("www.") === 0 && (o = o.substring("www.".length)),
        o
    } catch {
        return o
    }
...
function m(e, o, t) {
    ...
    if (t) {
        ...
        for (let r of Object.keys(t))
            r !== "style" && r !== "children" && (i[r] = t[r]);
        if (t.children)
            for (const [r,c] of Object.entries(t.children))
                n[r] = c,
                i.appendChild(c instanceof HTMLElement ? c : c.o);
        t.l && i.appendChild(t.l),
        t.init && t.init(i)
    }
...
function bo(e) {
    return e ? e.indexOf(":") === -1 ? "https://" + e : e.indexOf(Te) === 0 ? decodeURIComponent(e.substring(Te.length)) : e.startsWith(`${ye}placeholder.html?`) ? new URLSearchParams(e.substring(e.indexOf("?"))).get("url") : e : ""
}
function Ae(e) {
...
function *wo(e) {
    let o = 0;
    for (; Ie.slice(0, o).reduce((t,i)=>t + i, 0) < e; )
        yield Ie[o++]
}
...
function l(e) {
    ...
    return o || (console.log("No translation available for: " + e),
    e)
}
function yo(e, o, t) {
    return o && ((e || "").toLowerCase().startsWith("file:") || vo(e)) ? t ? `data:text/html, <html><body><div id="placeholderUrl">${e}</div></body></html>` : `${ye}placeholder.html?url=${encodeURI(e)}` : e
}
async function xo() {
    try {
...
function te(e, o, t) {
    return Array.isArray(e) ? e.map(i=>te(i, o, t)) : typeof e == "object" && e !== null ? Object.fromEntries(Object.entries(e).map(([i,n])=>[i, te(n, o, t)])) : e === o ? t : e
}
const vt = "c"
  , kt = "e"
  , Tt = "t";
...
let E, $, Ge, ie, Se, M, z, N, W, ne = "ontouchstart"in window;
function Mo({event: e, element: o, B: t, H: i, W: n, _: a}) {
    if (E = o,
    $ = t,
    Ge = i,
    ie = n,
...
function O(e) {
    ne && e instanceof TouchEvent ? (document.removeEventListener("touchmove", C, !1),
    document.removeEventListener("touchend", O, !1)) : (document.removeEventListener("mousemove", C, !1),
...
function zo(e, o) {
    return Q(e, "mouseover", o)
}
function Bt(e, o) {
    return Q(e, "mouseup", o)
}
function Fo(e, o) {
    let t;
    return t = i=>{
...
function jt(e, o) {
    e.onmouseout = t=>{
        ...
        i = t.currentTarget,
        n = t.relatedTarget,
        i === e && i !== n && !H(i, n) && o(new k(e,t))
    }
}
function Ut(e, o) {
    for (let t of e)
        t.onmouseout = Bo(t, e, o)
}
function Bo(e, o, t) {
    return i=>{
        let n, a;
        if (n = i.currentTarget,
        a = i.relatedTarget,
        n === e && n !== a && !H(n, a)) {
            for (let r of o)
                if (a === r)
...
function Q(e, o, t) {
    ...
    ;
    return e.addEventListener(o, i, !1),
    new De(e,o,i,!1)
}
function Et(e) {
    return Pe(e)
...
function Pe(e) {
    let o, t;
    return o = e.clientX + window.scrollX,
    t = e.clientY + window.scrollY,
    new Y(o,t)
}
function Le(e) {
...
async function Uo() {}
class ce {
    constructor({parent: o, label: t, Uo: i, Eo: n, isEnabled: a, So: r, className: c}) {
        this.div = m(o, "div", {
            style: {
                [`padding${A()}`]: i + "px",
                display: "inline-block",
    ...
    setEnabled(o) {
        this.isEnabled = o,
        this.isEnabled ? this.div.style.color = "" : this.div.style.color = "var(--text-color-weak)"
    }
}
function Me(e) {
...
function Eo(e, o) {
    ...
    Oe && T.jo.has(t)) {
        ...
        (async()=>(await q(),
        i.style.backgroundImage = "url(images/iconGrid.webp)"))()
    } else {
        let n = ao(e)
          , a = Me(n)
          , r = "images/globe.png"
        ...
        c.src = r,
        i.appendChild(c),
        !n || !n.includes(".") || n === "localhost" || n.startsWith("192.168.") || n.startsWith("172.16.") || n.startsWith("10.") || (ae ? (c.onload = ()=>{
            c.src.endsWith(r) || $e === Ee(c) && (c.onload = null,
            c.onerror = ()=>c.src = r,
            c.src = a)
        }
        ,
...
class Fe {
    constructor(o, t) {
                        ...
                        Ni: m(void 0, "a", {
                            ...
                            onclick: f=>{
                                ...
                                return (async()=>{
                                    ...
                                    p || this.co.locked || s === "keep" ? y ? await h.$a([{
                                        url: a,
                                        pinned: this.pinned
                                    }]) : await h.Je(a, !!this.pinned, !1) : (await h.Fa(this.co.eo, this.ho),
                                    await h.Je(a, !!this.pinned, !1),
                                    await h.De())
                                }
                                )(),
                                !1
        ...
        G.mi({
            ...
            pi: "tab",
            hi: ()=>{
                c.style.boxShadow = "var(--dragged-element-box-shadow)",
                c.style.backgroundColor = "var(--dragged-element-bg)"
            }
            ,
            fi: ()=>{}
            ,
    ...
    constructor(o, t) {
        ...
        this.ni = new ce({
            ...
            Eo: c=>{
                ...
                this.ci() >= 2 && (u = l("areYouSureYouWantToDeleteTheseTabs")),
                (J || confirm(u)) && h.Da(this.eo, !1)
            }
            ,
        ...
        let i = (c,u,f,p)=>{
            ...
            return y.addEventListener("mousedown", s=>{
                s.stopPropagation(),
                setTimeout(()=>re(), 1),
                setTimeout(()=>re(), 200),
                p(s)
          ...
          , n = m(void 0, "div", {
            ...
            children: {
                ...
                Li: i(this.le ? l("unstarTabGroup") : l("starTabGroup"), 6, "toggleStarTabGroupButton", c=>{
                    this.le = !this.le,
                    this.le && (this.ii = new Date().getTime()),
                    h.ka(this.eo, {
                        starred: this.le,
                        starredDate: this.ii
                    })
                ...
                ai: i(this.ro === "tabGroup" ? l("setToOpenAsRegularTabs") : l("setToOpenAsBrowserTabGroup"), 6, "toggleGroupTypeButton", async c=>{
                    await xe() ? (this.ro = this.ro === "tabGroup" ? "window" : "tabGroup",
                    h.ka(this.eo, {
                        groupType: this.ro
                    })) : /Opera|OPR\//.test(navigator.userAgent) && alert("Opera tab group support coming soon - please keep your browser up-to-date.")
                }
                ),
                Ci: i(l("copyLinksToClipboard"), 6, "copyLinksToClipboardButton", c=>{
                    const u = f=>f.tabGroups.find(p=>p.id === this.eo).tabsMeta.map(p=>`${p.url} | ${p.title}`).join(`
`);
                    (async()=>await navigator.clipboard.writeText(u(await h.getState())))()
                }
                ),
                Hi: i(l("help"), 0, "tabGroupHelpButton", c=>{
        ...
        this.Po = n,
        X || (this.Po.ai.style.display = "none");
        let a = m(void 0, "div", {
            className: "tabGroup",
            style: {
                paddingTop: "15px",
                                    ...
                                    children: {
                                        ...
                                        Ua: new ce({
                                            ...
                                            Eo: (c,u)=>{
                                                ...
                                                (async()=>await h.Ua([this.eo], !1).then(()=>{
                                                    de(u),
                                                    u.textContent = l("shareAsWebPage")
                                                }
                                                ))()
                                            }
                                            ,
        ...
        this.div = a.o,
        this.Vo = a.header.fo.Vo,
        this.Ro = a.header.fo.Ro,
        this.qo = a.header.fo.qo;
    ...
    Oo(o) {
        this.locked = o,
        Array.from(this.ao.values()).forEach(t=>t.Oo(o)),
    ...
    Lo(o) {
        let t = this.ao.get(o);
        t.div.parentElement && t.div.remove(),
        this.ao.delete(o)
    }
    Ei(o, t) {
        let i = this.ao.get(o);
...
function $o(e) {
    if (!e || e.toLowerCase().startsWith("file://"))
        return "";
    ...
    let o = co(e);
    return o.endsWith(".wikipedia.org") && (o = "wikipedia.org"),
    o
}
function Oo(e) {
...
function Ro(e) {
    let o = document.createElement("span")
      , t = e.indexOf("OneTab")
      , i = t + "OneTab".length;
    return t === 0 ? (o.appendChild(Ue()),
    o.appendChild(document.createTextNode(e.substring(i)))) : (o.appendChild(document.createTextNode(e.substring(0, t))),
    o.appendChild(Ue()),
...
function Ue() {
    ...
    return o.style.fontStyle = "italic",
...
setTimeout(async()=>{
        ...
        m(document.getElementById("contentAreaDiv"), "div", {
            ...
            children: {
                Yi: m(void 0, "div", {
                    children: {
                        a: m(void 0, "span", {
                            textContent: l("oneTabRestartRequired") + " "
                        }),
                        b: m(void 0, "a", {
                            style: {
                                cursor: "pointer",
                ...
                Zi: m(void 0, "div", {
                    l: m(void 0, "div", {
                        ...
                        textContent: l("mayNeedToRestartBrowser")
                    }).o
                })
            }
        }),
    ...
    if (!await h.Ca((await chrome.tabs.getCurrent()).id)) {
...
function Re(e) {
    ...
    if (o.length === 0)
        throw new Error("No matching tab group");
    if (o.length > 1)
        throw new Error("More than one matching tab group");
    return o
}
function Wo() {
    chrome.runtime.onMessage.addListener((e,o,t)=>{
        ...
        try {
            if (e.type === "ping")
                (async()=>(await ee(1e4, "waiting for tab groups to appear in onetab", ()=>!!document.getElementById("tabGroupsDiv")),
                t({
                    pong: !0
                })))();
                ...
                (async()=>{
                    let n;
                    try {
                        await ee(1e4, "waiting for tab link to appear", ()=>n = Array.from(document.getElementsByClassName("tabLink")).find(a=>a.href === e.url)),
...
class Ho {
    ...
    async Ri() {
        ...
        r.id = "tabGroupsDiv";
        let c = new Map
          , u = ()=>Array.from(c.values()).map(s=>s.ao.size).reduce((s,b)=>s + b, 0);
        a.forEach(s=>{
            let b = new _(s,this.uo);
            r.appendChild(b.div),
            c.set(s.id, b)
        }
        );
        let f = m(i, "div", {
          ...
          , p = s=>{
            n.textContent = Oo(s),
            f.style.display = s === 0 ? "block" : "none"
        }
        ;
        p(u());
        let y = (s,b)=>{
            if (s.type === "createTabGroup") {
                if (b) {
                    ...
                    c.delete(s.tabGroupId),
                    d.div.remove()
                } else {
                    let d = new _(s.tabGroup,this.uo);
                    L(d.div, r, s.index),
                    c.set(s.tabGroupId, d),
                    me("tabGroupView.scrollIntoView", 50, ()=>d.div.scrollIntoView())
                }
                p(u())
            } else if (s.type === "createTabs") {
                let d = c.get(s.tabGroupId);
                b ? s.newTabsMeta.forEach(g=>d.Lo(g.id)) : (d.Ui(s.newTabsMeta),
                me("tabGroupView.scrollIntoView", 50, ()=>d.div.scrollIntoView())),
                d.wo(),
                p(u())
            } else if (s.type === "deleteTabs") {
                let d = c.get(s.tabGroupId);
                b ? s.tabsMetaDeleted.forEach((g,w)=>d.Wo(g, s.tabIndicesDeleted[w])) : s.tabMetaIds.forEach(g=>d.Lo(g)),
                d.wo(),
                p(u())
                ...
                g.locked && w.Oo(g.locked[d]),
                g.index && w.Oi(g.index[d]),
                g.groupType && w.ji(g.groupType[d])
            } else if (s.type === "reorderTab")
                c.get(s.tabGroupId).Ei(s.tabMetaId, s[b ? "oldIndex" : "newIndex"]);
            else if (s.type === "moveTabBetweenTabGroups") {
                if (b && s.deletedSourceTabGroup) {
                    let g = new _(s.deletedSourceTabGroup,this.uo);
                    L(g.div, r, s.sourceTabGroupIndex),
                    c.set(g.eo, g)
                }
                ...
                if (b)
                    ...
                    s.deletedSourceTabGroup ? (c.delete(s.deletedSourceTabGroup.id),
                    g.div.remove()) : g.wo()
                }
                d.wo()
            }
        ...
        ;
        for (i.appendChild(r),
        document.getElementById("loadingSpinner").remove(); this.Co.length > 0; ) {
            let s = this.Co.shift();
            y(s.La, s.undo)
        }
        this.si = y
    ...
    qi() {
        ...
        m(document.getElementById("settingsDiv"), void 0, {
            ...
            children: {
                ln: m(void 0, "div", {
                    l: j(m(void 0, "div", {
                        l: Ro(l("bringAllTabsIntoOneTab"))
                    }).o, 14, ()=>{
                        (async()=>await h.Kt(void 0))()
                    }
                    )
                }),
                un: m(void 0, "div", {
                    l: j(l("shareAllAsWebPage"), o, t=>{
                        (async()=>{
                            ...
                            a || (a = []);
                            for (let r of a)
                                r.createDate || (r.createDate = new Date().getTime());
                            for (let r of a)
                                for (let c of r.tabsMeta)
                                    i.push(c);
                            i.length === 0 ? alert(l("noTabsInOneTabYet")) : (await h.Ua(void 0, !0),
                            t.textContent = l("shareAllAsWebPage"))
                        }
                        )()
                    }
                    )
...
function me(e, o, t, i) {
    i ? (delete se[e],
    t()) : se[e] || (se[e] = !0,
    setTimeout(()=>me(e, o, t, !0), o))
}
async function qe() {
    Lo() && (await Po().put("aliveIndicator", +new Date),
    setTimeout(qe, 1e4))
}
